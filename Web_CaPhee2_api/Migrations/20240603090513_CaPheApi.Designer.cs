...
namespace Web_CaPhee2_api.Migrations
{
    ...
    [Migration("20240603090513_CaPheApi")]
    partial class CaPheApi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_CaPhee2_api.Models.Contact", b =>
                {
            ...
            modelBuilder.Entity("Web_CaPhee2_api.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_CaPhee2_api.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Web_CaPhee2_api.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_CaPhee2_api.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Web_CaPhee2_api.Models.OrderDetail", b =>
                {
                    b.HasOne("Web_CaPhee2_api.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_CaPhee2_api.Models.Product", "Product")
                        .WithMany()
